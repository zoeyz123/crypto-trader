...
public class AvailableCryptoList {
	...
	/**
	 * This method checks for a list of available crypotcoins that can be read from CoinGecko's API. 
	 */
...
//		ALPHAVANTAGE API KEY = VNEY4VV2AWF1EB51
	...
	/**
	 * This is a getter method that returns the available cryptocoin list into an array 
	 * @return array of AvailableCryptocoinList 
	 */
	...
	/**
	 * This is a getter method that takes in a cryptocoin name and returns its corresponding ID
	 * @param cryptoName string representation of cryptocoin name 
	 * @return ID of cryptocoin passed in as a parameter 
	 */
